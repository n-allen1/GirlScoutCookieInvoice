...
int main(){
    ...
    while (city.length() == 0)
        {
            cout << "Enter the " << fname << " " << lname << "'s city: ";
            getline(cin, city);
        }
        cout << "City = " << city << endl;
    ...
    while (state.length() == 0)
        {
        cout << "Enter the " << fname << " " << lname << "'s state: ";
        getline(cin, state);
        }
    ...
    while (zip.length() == 0)
        {
        cout << "Enter the " << fname << " " << lname << "'s zip code: ";
        cin >> zip;
        }
        cout << "Zip: " << zip << endl;
...
outFile.open ("na_orders.txt", ios::out); //write
if (outFile.is_open()){
        outFile << "================================" << endl;
